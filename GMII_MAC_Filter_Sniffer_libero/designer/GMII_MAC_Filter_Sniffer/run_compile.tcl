...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"E:\Github_Repos\GMII_MAC_Filter_Sniffer\GMII_MAC_Filter_Sniffer_libero\synthesis\GMII_MAC_Filter_Sniffer.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {E:\Github_Repos\GMII_MAC_Filter_Sniffer\GMII_MAC_Filter_Sniffer_libero\designer\GMII_MAC_Filter_Sniffer} \
    -design GMII_MAC_Filter_Sniffer \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
    -merge_pdc 0 \
